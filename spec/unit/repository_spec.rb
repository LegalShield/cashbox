...
#allow(Vindicia::Request).to receive(:new).with(:get, '/bases').and_return(request)
#allow(Vindicia::Request).to receive(:get).with(:get, '/bases', { query: { } }).and_return(request)
#allow(Vindicia::Request).to receive(:get).with(:get, '/bases', { query: { limit: 1 } }).and_return(response)
